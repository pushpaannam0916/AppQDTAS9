...
//	    String data19 = e.getStringData("sheet2", 19, 0);    //in excel sheet gender is editiable of profile page     
//	   user1.EnterGender(data19);
//	   Thread.sleep(1000);
	   
//	    String data20 = e.getStringData("sheet2", 20, 0);    //in excel sheet gender is editiable of profile page     
//		user1.EnterGender1(data20);
//		Thread.sleep(1000);
